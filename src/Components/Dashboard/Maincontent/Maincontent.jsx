          ...
          >
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={() => setSelectedItem(item.id)} // Update selected item
                className="h-4 w-4"
              />
              <label
                htmlFor={`item-${item.id}`}
                className={`text-gray-700 capitalize ${selectedItem === item.id ? "line-through text-gray-500" : ""
                  }`}
              >
                {item.name}
              </label>
            ...
            <button
              ...
              className="mt-2 text-red-500 bg-red-100 hover:bg-red-200 p-2 rounded-full"
            >
              🗑️
            </button>
          </div>
